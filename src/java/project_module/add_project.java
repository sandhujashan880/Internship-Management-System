    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try{  
          ...
          Class.forName("com.mysql.jdbc.Driver");
           ...
           PreparedStatement ps1=conn.prepareStatement("INSERT INTO `internship`.`projects` (project,details)"
              ...
              if(i>0){
                   request.getSession().setAttribute("s", "Project added");
                   
                   String login = "add_project.jsp";
                 ...
                 request.getSession().setAttribute("f", "Project not added");
